...
export const blogPosts: BlogPost[] = [
  {
    ...
    category: 'Tutorial',
    image: '/nigerian_entrepreneur_campaign_guide_1775720710834.webp',
    author: 'Backr Team',
    date: 'April 9, 2024',
    readTime: '2 min read',
    content: `
...
Welcome to the future of African creativity. Let's get backed!
  ...
  },
  {
    ...
    category: 'Industry',
    image: '/transparency_trust_african_crowdfunding_1775720737123.webp',
    author: 'Backr Team',
    date: 'April 8, 2024',
    readTime: '1 min read',
    content: `
...
The African creative economy is booming, but to reach its full potential, we need platforms that prioritize trust. By being radicals about transparency, we are building a more sustainable ecosystem for everyone.
  ...
  },
  {
    ...
    category: 'Strategy',
    image: '/african_creators_marketing_meeting_1775720765531.webp',
    author: 'Backr Team',
    date: 'April 7, 2024',
    readTime: '2 min read',
    content: `
...
Don't wait until the campaign is over to talk to your backers. Use the Backr Update tool to share behind-the-scenes content, teasers, and "thank you" notes. This keeps the momentum alive throughout the 30-day window.
  ...
  },
  {
    ...
    category: 'Safety',
    image: '/nigerian_tech_professional_security_1775720793415.webp',
    author: 'Backr Team',
    date: 'April 6, 2024',
    readTime: '1 min read',
    content: `
...
We use world-class payment processors to handle all transactions. This means your financial data never touches our servers directly, and your contributions are protected by industry-standard encryption.
  ...
  },
  {
    ...
    category: 'Strategy',
    image: '/nigerian_digital_artist_designing_impact_1775720823018.webp',
    author: 'Backr Team',
    date: 'April 5, 2024',
    readTime: '1 min read',
    content: `
