...
import { PartyPopper, Palette, Landmark } from 'lucide-react';
    ...
    return (
      ...
      >
        <div style={{ maxWidth: '520px', width: '100%', textAlign: 'center' }}>
          ...
          >
            <PartyPopper size={40} color="#10b981" strokeWidth={1.5} />
          </div>
          <h1
            style={{
              fontSize: '2.5rem',
          ...
          <p
            style={{ fontSize: '1.1rem', color: '#475569', lineHeight: 1.6, marginBottom: '12px' }}
          >
            Thank you for joining the Backr Beta.
          </p>
          <p style={{ fontSize: '1rem', color: '#64748b', lineHeight: 1.6, marginBottom: '40px' }}>
            We&apos;re putting the final touches on the platform. We&apos;ll reach out to you
            personally as soon as it&apos;s ready — you&apos;ll be among the very first to get in.
          </p>
          <div
            style={{
              padding: '20px 24px',
          ...
          >
            <p style={{ margin: '0 0 6px', fontSize: '0.9rem', color: '#64748b' }}>
              We&apos;ve sent a welcome note to{' '}
              <strong style={{ color: '#0f172a' }}>{formData.email}</strong>.
            </p>
            <p style={{ margin: 0, fontSize: '0.82rem', color: '#94a3b8' }}>
              Can&apos;t find it? Check your{' '}
              <strong style={{ color: '#475569' }}>spam / junk folder</strong> — it may have landed
              there.
            </p>
          </div>
          <a
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '40px 24px' }}>
        ...
        >
          <a href="/" style={{ textDecoration: 'none' }}>
            ...
            >
              Backr<span style={{ color: '#0f172a' }}>.beta</span>
            </h2>
          </a>
          <a
            href="/login"
        ...
        >
          ...
          >
            Join the elite circle of creators and backers shaping the next generation of creative
            equity. Verified Beta access only.
          </p>
            ...
            {step === 1 ? (
              <div>
                ...
                <p style={{ color: '#64748b', fontSize: '0.95rem', marginBottom: '32px' }}>
                  Choose how you&apos;ll participate in the Backr ecosystem.
                </p>
                ...
                >
                  {[
                    { id: 'individual', title: 'Independent Creator', icon: <Palette size={24} /> },
                    {
                      id: 'organization',
              ...
              <form onSubmit={handleSignup}>
                ...
                <p style={{ color: '#64748b', fontSize: '0.95rem', marginBottom: '32px' }}>
                  Finalize your secure beta credentials.
                </p>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <label style={{ fontSize: '0.85rem', color: '#475569', fontWeight: 700 }}>
                      Full Name
                    </label>
                    <input
                      type="text"
        ...
        <footer
          style={{ marginTop: '80px', textAlign: 'center', color: '#94a3b8', fontSize: '0.85rem' }}
        >
