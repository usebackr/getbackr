        ...
        <div className="dash-card" style={{ padding: 'clamp(24px, 5vw, 40px)' }}>
          ...
          {step === 1 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <h2 style={{ fontSize: '1.25rem', marginBottom: '8px', fontWeight: 800 }}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. My Next Indie Film"
                  style={{
                    width: '100%',
                    padding: '14px',
                    borderRadius: '12px',
              ...
              <div>
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: '0.8rem',
                      fontWeight: 700,
                      color: formData.description.length < 100 ? '#ef4444' : '#059669',
                    }}
                  >
                ...
                <textarea
                  ...
                  style={{
                    ...
                    padding: '14px',
                    borderRadius: '12px',
                    border: `1px solid ${formData.description.length < 100 && formData.description.length > 0 ? '#ef4444' : '#e2e8f0'}`,
                    resize: 'vertical',
                  }}
                />
                {formData.description.length > 0 && formData.description.length < 100 && (
                  ...
                  >
                    Please add {100 - formData.description.length} more characters to continue.
                  </p>
                )}
              </div>
              <div style={{ marginTop: '16px', display: 'flex', justifyContent: 'flex-end' }}>
                <button
                  ...
                  style={{ padding: '14px 40px', opacity: !isStep1Valid ? 0.5 : 1 }}
                >
                  Next
                </button>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ marginTop: '16px', display: 'flex', justifyContent: 'space-between' }}>
                <button
                  ...
                  style={{ padding: '14px 40px', background: '#f1f5f9', border: 'none' }}
                >
                  Back
                </button>
                <button
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                ...
                <div
                  ...
                  style={{
                    ...
                    background: formData.coverImageUrl
                      ? `url(${formData.coverImageUrl}) center/cover no-repeat`
                      : '#f8fafc',
              ...
              <div style={{ marginTop: '32px', display: 'flex', justifyContent: 'space-between' }}>
                ...
                <button
                  ...
                  className="btn-primary"
                  style={{ padding: '14px 40px' }}
                  disabled={loading || uploading || !formData.coverImageUrl}
                >
