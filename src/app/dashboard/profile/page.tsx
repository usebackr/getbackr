          ...
          <div style={{ maxWidth: '1000px' }}>
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: '0.85rem', opacity: 0.9, fontWeight: 600 }}>
                  The more information you share, the more backers trust you. Projects with complete
                  social profiles are twice as likely to reach their goal.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="dash-card">
                <h3 style={{ fontSize: '1.2rem', fontWeight: 800, marginBottom: '24px' }}>
                  Public Identity
                </h3>
              ...
              <div className="dash-card">
                ...
                >
                  Link your active profiles to build credibility and let donors connect with your
                  work.
                </p>
