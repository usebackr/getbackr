...
export async function POST(req: NextRequest) {
  try {
    ...
    // 3. Expire any existing un-used password_change otps for this user to prevent confusion
    ...
    if (!emailResult.sent) {
      console.error('[Password Change OTP] Failed to send email:', emailResult.error);
