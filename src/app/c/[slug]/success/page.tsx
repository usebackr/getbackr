      ...
      >
        ...
        <div
          style={{
            ...
            height: '80px',
            background:
              status === 'confirmed' ? 'rgba(16, 185, 129, 0.1)' : 'rgba(59, 130, 246, 0.1)',
            borderRadius: '40px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        ...
        <h1
          style={{ fontSize: '2.25rem', fontWeight: 900, color: '#0f172a', marginBottom: '12px' }}
        >
          {status === 'confirmed' ? 'Contribution Confirmed!' : 'Thank You!'}
        </h1>
        <p
          style={{ fontSize: '1.1rem', color: '#475569', lineHeight: '1.6', marginBottom: '32px' }}
        >
          {status === 'confirmed'
