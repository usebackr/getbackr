      ...
      <main style={{ flex: 1, padding: 'clamp(80px, 15vw, 120px) 24px 60px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <header style={{ textAlign: 'center', marginBottom: '80px' }}>
            ...
            >
              A simple, transparent flow designed to empower creators and build lasting trust with
              backers.
            </p>
          </header>
          ...
          >
            <h2 style={{ fontSize: 'clamp(2rem, 5vw, 2.5rem)', marginBottom: '20px' }}>
              Ready to get started?
            </h2>
            <p style={{ opacity: 0.8, marginBottom: '40px', fontSize: '1.1rem' }}>
              Initiate your campaign today and join the community of trusted creators.
            </p>
            <a
